package edu.dtcc.emailman.cis282listview1;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView fruitsList = (ListView) findViewById(R.id.fruitslist);
        ...
        fruitsList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                selectedOpt.setText("You selected " + fruitsArray[position]);
            }
        });
    }
